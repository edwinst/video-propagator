...
%     XXX label abs value as +/-
%     XXX display abs value one-sided for integral
%     XXX display 1/sigma in the contour window
...
\pause
\bigskip
See Peskin \& Schroeder, \textit{An Introduction to Quantum Field Theory}, 2.50 to 2.52.
...
\pause
\medskip
Riemann -- ``$\lim_{b \to \infty} \int_0^b \ldots$ does not exist.''
...
\begin{itemize}
\item ... at large imaginary values are neglibible
...
\pause
\item ... at $\Re p = \pm \Lambda$ contribute the cutoff oscillations
...
\pause
\item ... close to $\Re p = 0$ contribute the exponentially falling part
