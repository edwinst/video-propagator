...
%:          --pre-plot 'set label "cutoff = %4.2g" at 5,5 font "serif,26"'}, $Pr),
%:      $im_int]
%: });
...
%:      sprintf(qq{
%:          --pre-plot 'set label "1/σ = 30" at 5,8 font "serif,26"'
%:          --pre-plot 'set label "cutoff = %4.2g" at 5,5 font "serif,26"'}, 70),
%:      $im_ints]
%: });
...
%:     }
%:     if ($t > 0.3) {
%:         $plot .= q{ --pre-plot 'set label "zooming..." at 5,8 font "serif,26"' };
%:     }
